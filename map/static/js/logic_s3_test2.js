...
const layerGroups = {
    ...
    ind21ss: ['11', '21', '22', '23', '31'],
    ind22ss: ['11', '12', '13'],
    ind23ss: ['61', '62', '71', '72', '73', '79', '81', '82', '83', '89'],
    ind31ss: ['11', '12', '13', '14', '15', '16', '17', '18', '19', '21', '22', '31', '32', '33', '41', '49', '51', '52', '59', '61', '62', '69'],
    ind32ss: ['11', '12', '19', '21', '22', '31', '41', '51', '52', '53', '54', '55', '56', '59', '61', '62', '71', '72', '73', '74', '79'],
    ind33ss: ['11', '12', '13', '14', '15', '21', '22', '23', '24', '25', '26', '27', '28', '29', '31', '32', '33', '34', '35', '36', '39', '41', '42', '43', '44', '45', '46', '51', '52', '53', '59', '61', '62', '63', '64', '65', '66', '69', '71', '72', '79', '91', '99'],
    ind42ss: ['31', '32', '33', '34', '35', '36', '37', '38', '39', '41', '42', '43', '44', '45', '46', '47', '48', '49', '51'],
    ind44ss: ['11', '12', '13', '21', '22', '31', '41', '42', '51', '52', '53', '61', '71', '81', '82', '83'],
    ind45ss: ['11', '12', '22', '23', '31', '32', '33', '39', '41', '42', '43'],
    ind48ss: ['11', '12', '21', '31', '32', '41', '42', '51', '52', '53', '54', '55', '59', '61', '62', '69', '71', '72', '79', '81', '82', '83', '84', '85', '89'],
    ind49ss: ['11', '21', '22', '31'],
    ind51ss: ['11', '12', '21', '22', '51', '52', '73', '74', '79', '82', '91'],
    ind52ss: ['11', '21', '22', '23', '31', '32', '39', '41', '42', '51', '59'],
    ind53ss: ['11', '12', '13', '21', '22', '23', '24', '31'],
    ind54ss: ['11', '12', '13', '14', '15', '16', '17', '18', '19'],
    ind55ss: ['11'],
    ind56ss: ['11', '12', '13', '14', '15', '16', '17', '19', '21', '22', '29'],
    ind61ss: ['11', '12', '13', '14', '15', '16', '17'],
    ind62ss: ['11', '12', '13', '14', '15', '16', '19', '21', '22', '23', '31', '32', '33', '39', '41', '42', '43', '44'],
    ind71ss: ['11', '12', '13', '14', '15', '21', '31', '32', '39'],
    ind72ss: ['11', '12', '13', '23', '24', '25'],
    ind81ss: ['11', '12', '13', '14', '21', '22', '23', '29', '31', '32', '33', '34', '39', '41'],
    ind92ss: ['11', '21', '31', '41', '51', '61', '71', '81'],
    ind99ss: ['00'],
    loanRanges: ['A', 'B', 'C', 'D', 'E'],
    jobRanges: ['1', '2', '3', '4', '5', '6', '7', '8'],
    businessTypes: ['01', '02', '03', '04', '05'],
    businessAges: ['1', '2', '3', '4', '5'],
    pmStatus: ['PPP', 'PPS']

  };

// Create layer groups using loops
const createLayerGroups = (prefix, suffixes) => {
    return suffixes.reduce((groups, suffix) => {
      groups[`${prefix}${suffix}group`] = new L.layerGroup();
      return groups;
    }, {});
  };
  const layers = {
    ...createLayerGroups('ind00ss', layerGroups.ind00ss),
    ...createLayerGroups('ind11ss', layerGroups.ind11ss),
    ...createLayerGroups('ind21ss', layerGroups.ind21ss),
    ...createLayerGroups('ind22ss', layerGroups.ind22ss),
    ...createLayerGroups('ind23ss', layerGroups.ind23ss),
    ...createLayerGroups('ind31ss', layerGroups.ind31ss),
    ...createLayerGroups('ind32ss', layerGroups.ind32ss),
    ...createLayerGroups('ind33ss', layerGroups.ind33ss),
    ...createLayerGroups('ind42ss', layerGroups.ind42ss),
    ...createLayerGroups('ind44ss', layerGroups.ind44ss),
    ...createLayerGroups('ind45ss', layerGroups.ind45ss),
    ...createLayerGroups('ind48ss', layerGroups.ind48ss),
    ...createLayerGroups('ind49ss', layerGroups.ind49ss),
    ...createLayerGroups('ind51ss', layerGroups.ind51ss),
    ...createLayerGroups('ind52ss', layerGroups.ind52ss),
    ...createLayerGroups('ind53ss', layerGroups.ind53ss),
    ...createLayerGroups('ind54ss', layerGroups.ind54ss),
    ...createLayerGroups('ind55ss', layerGroups.ind55ss),
    ...createLayerGroups('ind56ss', layerGroups.ind56ss),
    ...createLayerGroups('ind61ss', layerGroups.ind61ss),
    ...createLayerGroups('ind62ss', layerGroups.ind62ss),
    ...createLayerGroups('ind71ss', layerGroups.ind71ss),
    ...createLayerGroups('ind72ss', layerGroups.ind72ss),
    ...createLayerGroups('ind81ss', layerGroups.ind81ss),
    ...createLayerGroups('ind92ss', layerGroups.ind92ss),
    ...createLayerGroups('ind99ss', layerGroups.ind99ss),
    ...createLayerGroups('LoanRange', layerGroups.loanRanges),
    ...createLayerGroups('JR', layerGroups.jobRanges),
    ...createLayerGroups('BT', layerGroups.businessTypes),
    ...createLayerGroups('BA', layerGroups.businessAges),
    ...createLayerGroups('PPP', layerGroups.pmStatus[0]),
    ...createLayerGroups('PPS', layerGroups.pmStatus[1]),
    '51group': new L.layerGroup(),
    '24group': new L.layerGroup(),
    '17group': new L.layerGroup(),
    '48group': new L.layerGroup(),
  };

// Simplify object creation using loops
const objSS = {};
